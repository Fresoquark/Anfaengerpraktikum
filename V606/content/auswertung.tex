...
Name & S & L & J & $g_J$ \\
  ...
  \end{tabular}
\end{table}
Die Momente pro Volumeneinheit $N=N_A \cdot \frac{\rho}{M}$ werden aus den aus \cite{sample} entnommenen Dichten, den aus \cite{molmassen} entnommenen molaren Massen und der
