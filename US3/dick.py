...
rpm,a,b,c=np.genfromtxt("data/dick.csv",delimiter=",",unpack=True)    # a=15 b=30 c=60
...
np.savetxt("data/dicktab.csv",np.column_stack([vfluss,a,v15,b,v30,c,v60,vm,vmerr]),delimiter=",",fmt=["%2.0f","%4.0f","%4.2f","%4.0f","%4.2f","%4.0f","%4.2f","%4.2f","%4.2f"])
